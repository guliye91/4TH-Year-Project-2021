...
$pdf->AddPage();
$date = $_SESSION['dateReceived1'];
$photo = $_SESSION['photoOption'];
$from = $_SESSION['source'];
$amount = $_SESSION['amountPaid1'];
...
<p><b>Photo Option:</b><br/>'.$photo.'</p>
<p><b>Taken From:</b><br/>'.$from.'</p>
...
$pdf->lastPage();
$pdf->Output('receipt'.$photo.'.pdf', 'I');
